...
export default function PlatformOperate() {
  const { board, isLoading } = useAdminTaskBoard('platform_admin');
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Daily tasks, planning, and communications</p>
      </div>
