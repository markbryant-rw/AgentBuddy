...
const SystemTransactionTemplates = lazy(() => import('./pages/platform-admin/SystemTransactionTemplates'));
...
const RescuePipeline = lazy(() => import("./pages/RescuePipeline"));
        ...
        <Routes>
          ...
          <Route path="/landing-alt" element={<LandingAlt />} />
            ...
            <Route path="/tasks/matrix" element={<TaskMatrix />} />
              ...
              <Route path="/rescue-pipeline" element={<RescuePipeline />} />
              <Route path="/relationship-dashboard" element={<RelationshipDashboard />} />
                ...
                <Route element={<ProtectedRoute><PlatformAdminLayout /></ProtectedRoute>}>
                  ...
                  <Route path="/platform-admin/transaction-templates" element={<SystemTransactionTemplates />} />
