...
import { Shield, Users, Activity, Clock, Search } from 'lucide-react';
...
export default function ImpersonationAudit() {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Impersonation Audit</h1>
        <p className="text-muted-foreground">
          Complete audit trail of all user impersonation sessions
        </p>
      </div>
