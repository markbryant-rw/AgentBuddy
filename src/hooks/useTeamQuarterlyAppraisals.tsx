...
export const useTeamQuarterlyAppraisals = (teamId: string | undefined) => {
  return useQuery({
    queryKey: ['team-quarterly-appraisals', teamId],
    queryFn: async () => {
      if (!teamId) return { total: 0, high: 0, medium: 0, low: 0, monthlyPace: 0 };
