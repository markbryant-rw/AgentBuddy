...
BEGIN
  ...
  -- GOALS (use 'individual' enum value)
  INSERT INTO goals (title, goal_type, kpi_type, target_value, current_value, start_date, end_date, team_id, user_id, created_by, period)
  VALUES
    ('Q1 Listings Target', 'individual', 'listings', 8, 5, DATE_TRUNC('quarter', CURRENT_DATE), DATE_TRUNC('quarter', CURRENT_DATE) + INTERVAL '3 months' - INTERVAL '1 day', v_demo_team_id, v_demo_user_id, v_demo_user_id, 'quarterly'),
    ('Q1 Sales Target', 'individual', 'sales', 6, 4, DATE_TRUNC('quarter', CURRENT_DATE), DATE_TRUNC('quarter', CURRENT_DATE) + INTERVAL '3 months' - INTERVAL '1 day', v_demo_team_id, v_demo_user_id, v_demo_user_id, 'quarterly');

  -- SERVICE PROVIDERS (5)
  INSERT INTO service_providers (name, category, phone, email, rating, team_id, created_by)
  VALUES
    ('Auckland Property Photos', 'photographer', '021 555 0101', 'bookings@aucklandphotos.co.nz', 5, v_demo_team_id, v_demo_user_id),
    ('NZ Home Staging', 'stager', '021 555 0102', 'hello@nzhomestaging.co.nz', 5, v_demo_team_id, v_demo_user_id),
    ('Bright & Co Legal', 'lawyer', '09 555 0103', 'conveyancing@brightlegal.co.nz', 4, v_demo_team_id, v_demo_user_id),
    ('Smith Building Inspections', 'building_inspector', '021 555 0104', 'reports@smithinspections.co.nz', 5, v_demo_team_id, v_demo_user_id),
    ('Fresh Look Painters', 'painter', '021 555 0105', 'quotes@freshlookpainters.co.nz', 4, v_demo_team_id, v_demo_user_id);
END;
$function$;